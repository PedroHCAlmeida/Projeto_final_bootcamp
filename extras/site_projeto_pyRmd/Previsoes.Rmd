...
![](https://raw.githubusercontent.com/PedroHCAlmeida/Projeto_final_bootcamp/main/img/roc_curve.jpg?token=ASNXTHRPZWZSIUSKA57LS2LBB3SVG)
...
![](https://raw.githubusercontent.com/PedroHCAlmeida/Projeto_final_bootcamp/main/img/dataml_cross_validation.png?token=ASNXTHSHEXSDXFKCCL6AFZ3BB3SXK)
...
```{python, fig.keep = 'last'}
ax10 = best.hist_metrics(kde=True, color=(0.12156862745098039, 0.4666666666666667, 0.7058823529411765, 0.5), 
...
```{python, fig.keep = 'last'}
ax11 = best.plot_confusion(name_estimator='final')
plt.show()
```
