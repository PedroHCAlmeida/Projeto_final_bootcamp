...
```{python grafico1, eval=FALSE, echo=TRUE}
#Criando a figura
...
```{python grafico11, echo=FALSE, fig.keep='last'}
#Criando a figura
fig, ax1 = plt.subplots(figsize=(20,10)) 
...
```{python grafico2, eval=FALSE, echo=TRUE}
#Criando a figura
...
```{python grafico22, echo=FALSE, fig.keep='last'}
#Criando a figura
fig, ax2 = plt.subplots(figsize=(20,10)) 
